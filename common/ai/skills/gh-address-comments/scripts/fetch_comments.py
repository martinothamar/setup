...
Usage:
  python fetch_comments.py                          # fetch and print PR comments as JSON
  python fetch_comments.py --resolve ID [ID ...]    # resolve review threads by ID
"""
...
def main() -> None:
    ...
    if args.resolve:
        ...
        for thread_id in args.resolve:
            ...
            print(f"Resolved thread {thread['id']}: isResolved={thread['isResolved']}", file=sys.stderr)
